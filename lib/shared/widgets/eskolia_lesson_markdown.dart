...
class EskoliaLessonMarkdown extends StatelessWidget {
  ...
  static MarkdownStyleSheet _sheet() {
    ...
    final codeText = EskoliaTypography.code(EskoliaTokens.cyan);
    ...
    return MarkdownStyleSheet(
      ...
      horizontalRuleDecoration: BoxDecoration(
        border: Border(
          top: BorderSide(
            color: EskoliaTokens.textPrimary.withValues(alpha: 0.14),
            width: 1,
          ),
        ),
      ),
      ...
      tableBorder: TableBorder.all(
        color: EskoliaTokens.textPrimary.withValues(alpha: 0.12),
      ),
