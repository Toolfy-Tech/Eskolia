          ...
          return ListView(
            ...
            children: [
              ...
              Text(
                ...
                style: const TextStyle(color: EskoliaTokens.cyanSoft, fontWeight: FontWeight.w600),
              ),
              ...
              Row(
                children: [
                  ...
                  Text(
                    '${_maxQuestions.round()}',
                    style: const TextStyle(color: EskoliaTokens.cyanSoft, fontWeight: FontWeight.w700),
                  ),
                ],
              ),
              Slider(
              ...
              SwitchListTile(
                ...
                activeThumbColor: EskoliaTokens.cyanSoft,
                onChanged: (v) =>
          ...
          decoration: BoxDecoration(
            ...
            gradient: LinearGradient(
              colors: [
                ...
                EskoliaTokens.cyanSoft.withValues(alpha: 0.2),
              ],
            ),
