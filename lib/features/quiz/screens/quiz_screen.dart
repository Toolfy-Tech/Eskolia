                  ...
                  FractionallySizedBox(
                    ...
                    child: Container(
                      decoration: const BoxDecoration(
                        gradient: LinearGradient(colors: [EskoliaTokens.violetSoft, EskoliaTokens.cyanSoft]),
                      ),
                    ),
                  ),
                ],
        ...
        if (q.type == 'diagnostic_indices' && q.indices != null) ...[
          ...
          ...List.generate(state.revealedIndicesCount, (i) {
            return Container(
              ...
              child: Text(
                q.indices![i],
                style: const TextStyle(color: EskoliaTokens.cyanSoft, fontSize: 13, fontStyle: FontStyle.italic),
              ),
            );
          }),
  ...
  Widget _buildSequenceReorder(QuizQuestion q) {
    ...
    return Column(
      ...
      children: [
        Row(
          children: [
            const Icon(Icons.swap_vert_rounded, color: EskoliaTokens.cyanSoft, size: 16),
            const SizedBox(width: 6),
            const Text(
              'GLISSE POUR ORDONNER',
              style: TextStyle(color: EskoliaTokens.cyanSoft, fontSize: 11, fontWeight: FontWeight.w900, letterSpacing: 0.8),
            ),
          ],
        ),
