...
class MegaMediathequeScreen extends StatefulWidget {
  const MegaMediathequeScreen({super.key});

  @override
  State<MegaMediathequeScreen> createState() => _MegaMediathequeScreenState();
}

class _MegaMediathequeScreenState extends State<MegaMediathequeScreen> {
  late final Future<List<ModuleMediatheque>> _future =
      OptimusMediathequeRepository.loadAll();
  String? _filter;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          SafeArea(
            top: false,
            child: FutureBuilder<List<ModuleMediatheque>>(
              future: _future,
              builder: (context, snap) {
                ...
                final totalLinks = shown.fold(
                    0, (sum, m) => sum + m.specific.length + m.veille.length);
                return Column(
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, i) {
                          ...
                          return MediathequeSection(
                            specific: mod.specific,
                            veille: mod.veille,
                            title: '${label.id} — ${label.name}',
