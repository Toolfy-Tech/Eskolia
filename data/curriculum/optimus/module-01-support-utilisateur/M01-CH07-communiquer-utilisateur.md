> **Parcours Optimus — Module 1 · Chapitre 7 sur 9**
...
## Le paysage logiciel de l'utilisateur
...
| **Logiciels métiers** | ERP (SAP, Sage...), CRM (Salesforce...), logiciels spécialisés | Coeur d'activité de l'entreprise — souvent critiques |
